...
void AcctABC::Withdraw(double amt)//ДПащ
{
    balance -= amt; 
}
...
AcctABC::Formatting AcctABC::SetFormat()const
{
    Formatting f; 
    f.flag =
        cout.setf(ios_base::fixed, ios_base::floatfield); //return (_Oldfmtflags);
...
void BrassPlus::Withdraw(double amt)
{
    ...
    else if (amt <= bal + maxLoan - owesBank)
    {
        ...
        cout << "Bank advancce: $" << advance << endl;
